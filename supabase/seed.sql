...
insert into public.profiles (id, username, role, name, birth_year, status, bio, interests, study_field,
                             postal_code, city, lat, lng)
values
  ('11111111-1111-1111-1111-111111111111', 'lena-vogt', 'student', 'Lena Vogt', 2002, null,
  ...
  ('22222222-2222-2222-2222-222222222222', 'tariq-haddad', 'student', 'Tariq Haddad', 2003, null,
  ...
  ('33333333-3333-3333-3333-333333333333', 'ingrid-schaefer', 'senior', 'Ingrid Schäfer', 1948, 'rentnerin',
  ...
  ('44444444-4444-4444-4444-444444444444', 'werner-pohl', 'senior', 'Werner Pohl', 1945, 'rentner',
  ...
  ('55555555-5555-5555-5555-555555555555', 'elisabeth-wagner', 'senior', 'Elisabeth Wagner', 1957, 'berufstaetig',
